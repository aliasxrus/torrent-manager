...
6. При получении списка торрентов скрипт увидит остановленные торренты и приступит к скачиванию, информацию о процессе
   скачивания можно посмотреть в колонке _**Метка**_ или _**Label**_. Если скрипт обнаружит что μTorrent/BitTorrent
   скачивает файл, то он их _**остановит**_ и при следующей проверке запустит автоматическое скачивание.
